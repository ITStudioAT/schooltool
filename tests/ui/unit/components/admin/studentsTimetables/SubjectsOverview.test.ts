...
describe('Students timetable subjects overview', () => {
    ...
    it('adds the subjects overview menu item to the module shell', () => {
        ...
        expect(componentSource).toContain('/admin/students-timetables/timetable/robot')
        ...
        expect(componentSource).toContain("this.$router.replace({ path: '/admin/students-timetables/timetable/robot' })")
