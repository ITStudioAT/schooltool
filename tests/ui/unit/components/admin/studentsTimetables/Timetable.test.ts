...
describe('Students timetable timetable page', () => {
    it('shows the timetable overview on the timetable overview subpage', () => {
        ...
        expect(componentSource).toContain("{ key: 'robot', label: 'Wizzard' }")
        ...
        expect(componentSource.indexOf("{ key: 'overview', label: 'Übersicht' }"))
            .toBeLessThan(componentSource.indexOf("{ key: 'robot', label: 'Wizzard' }"))
        expect(componentSource).toContain("const allowed = this.canManageTimetableImports")
        expect(componentSource).toContain("['overview', 'robot', 'imports']")
        expect(componentSource).toContain("['overview', 'robot']")
