...
describe('Restaurant settings component', () => {
    ...
    it('opens the ingredient icon import dialog, shows the directory entries and imports the selected symbols', async () => {
        ...
        expect((wrapper.vm as any).ingredientIconImportSourceDirectory).toBe('storage/app/private/restaurant/ingredient_icons')
        expect(wrapper.text()).not.toContain('storage/app/private/restaurant/ingredient_icons')
