...
describe('book', function () {
    ...
    })->throws(\Symfony\Component\HttpKernel\Exception\HttpException::class, 'Die Registrierung ist geschlossen');
    ...
    it('throws exception when register date is locked', function () {
        ...
        $this->service->book($this->user, $data);
    })->throws(\Symfony\Component\HttpKernel\Exception\HttpException::class, 'Der Termin ist gesperrt');
    ...
    it('throws exception when register date is fully booked', function () {
        ...
        $this->service->book($this->user, $data);
    })->throws(\Symfony\Component\HttpKernel\Exception\HttpException::class, 'Der Termin ist bereits ausgebucht');
    ...
    it('throws exception when register is fully booked', function () {
        ...
        $this->service->book($this->user, $data);
    })->throws(\Symfony\Component\HttpKernel\Exception\HttpException::class, 'Die Registrierung ist bereits ausgebucht');
    ...
    it('throws exception when user already has a booking', function () {
        ...
        $this->service->book($this->user, $data);
    })->throws(\Symfony\Component\HttpKernel\Exception\HttpException::class, 'Sie haben bereits eine Buchung');
