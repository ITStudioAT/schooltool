...
class AdminService
{
    ...
    public function sendPasswordResetToken($select, $user, $email)
    {
    ...
    public function sendRegisterToken($select, $user, $email)
    {
        $token_2fa = $user->setToken2Fa(config('spa.token_expire_time'), $select);
    ...
    public function sendEmailValidationToken($select, $user, $email)
    {
        $token_2fa = $user->setToken2Fa(config('spa.token_expire_time'), $select);
