<template>
    <div
        ...
        <TimetablePrintDialog
            ...
            v-model:course-overview="printOptions.courseOverview"
            :can-print="Boolean(selectedTimetableV2Result)"
            :exporting="pdfExporting"
            @print="downloadAdoptedTimetablePdf" />
...
<style scoped src="./TimetableV2.css"></style>
