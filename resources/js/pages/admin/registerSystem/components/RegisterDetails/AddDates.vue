    ...
    <v-col cols="12" md="4" xl="3">
        <its-grid-box color="primary" title="Neue Termine" class="w-100">
            <v-form ref="form" v-model="is_valid" @submit.prevent="createDates(data)" class="mb-4">
                <v-row dense>
                    <v-col cols="12">
                        <v-text-field autofocus v-model="data.date_from" hide-details label="Datum von (JJJJ-MM-TT)" :rules="[date()]" />
                    </v-col>
                </v-row>
                <v-row dense>
                    <v-col cols="12">
                        <v-text-field v-model="data.date_until" hide-details label="Datum bis (JJJJ-MM-TT), kann leer bleiben" :rules="[dateOrNull()]" />
                    </v-col>
                </v-row>

                <v-row dense>
                    <v-col cols="12">
                        <v-text-field v-model="data.time_from" label="Uhrzeit von (hh:mm)" :rules="[required(), time()]" />
                    </v-col>
                </v-row>

                <v-row dense>
                    <v-col cols="12">
                        <v-text-field v-model="data.time_until" label="Uhrzeit bis (hh:mm)" :rules="[required(), time()]" />
                    </v-col>
                </v-row>

                <v-row dense>
                    <v-col cols="12">
                        <v-text-field v-model="data.min_per_date" label="Minuten pro Termin" :rules="[required(), min(1)]" />
                    </v-col>
                </v-row>
                ...
                <v-row dense>
                    <v-col cols="12">
                        <v-text-field v-model="data.max_registrations" label="Max. Registrierungen pro Termin (0=unbegrenzt)" :rules="[required(), min(0)]" />
                    </v-col>
                </v-row>
                ...
                <v-row dense>
                    <v-col cols="12">
                        <v-text-field v-model="data.supervisor_1" label="Berater 1" :rules="[required(), maxLength(255)]" />
                    </v-col>
                </v-row>
                <v-row dense>
                    <v-col cols="12">
