...
export default {
    components: { Schools, Schoolyears, Users, Licences, LicenceSchools, Roles, Log, ModuleStatusesCard, ActiveSchool, UserImpersonation, StorageAudit, PreviewAccess, Groups },
