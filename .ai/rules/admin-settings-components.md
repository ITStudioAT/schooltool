...
paths:
  ...
  - '{app/Http/Controllers/Admin/StudentsTimetables/TeacherAccountController.php,app/Http/Requests/Admin/StudentsTimetables/*TeacherRosterEntryRequest.php,resources/js/pages/admin/settings/components/StudentsTimetablesTeachers.vue}'
---
...
## Create manual teacher roster entries as imported teachers
The Lehrerliste Hinzufügen flow creates an active Teacher row in the authenticated manager's school. Normalize roster identity fields, reject email collisions across both Teacher and User rows in that school, and keep creation restricted to existing teacher-roster manager roles.
