...
class AppUpdateCommand extends Command
{
    ...
    public function handle(InstallUpdateService $service, RecordsCreateService $recordsCreateService): int
    {
        ...
        $service->createRoles(['super_admin', 'admin', 'register_admin', 'register_user', 'tutoring_user', 'tutoring_admin', 'teacher', 'lunch_admin', 'lunch_user', 'teaching_admin', 'materials_admin', 'student']);
