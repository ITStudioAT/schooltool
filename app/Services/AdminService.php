...
class AdminService
{
    ...
    public function checkLogin(array $data): array
    {
        ...
        $allowedRoles = ['super_admin', 'admin', 'register_admin', 'tutoring_admin', 'teaching_admin', 'materials_admin', 'teacher', 'lunch_admin'];
    ...
    public function checkUserLogin(array $data): User
    {
        ...
        $allowedRoles = ['super_admin', 'admin', 'user', 'register_admin', 'tutoring_admin', 'teaching_admin', 'materials_admin', 'teacher', 'lunch_admin'];
        if (! $user->hasAnyRole($allowedRoles)) {
