...
class AccessScopeService
{
    ...
    private const SCOPES = [
        ...
        'admin_user_profile_access' => ['user', 'super_admin', 'admin', 'register_admin', 'teaching_admin', 'materials_admin', 'teacher', 'studentstimetables_admin', 'studentstimetables_moderator'],
        'teaching_upload_access' => ['admin', 'teaching_admin'],
        'school_tool_access' => ['super_admin', 'admin', 'register_admin', 'teacher'],
        ...
        'staff_admin_access' => ['admin', 'register_admin', 'teaching_admin', 'materials_admin', 'materials_moderator', 'teacher'],
        'tool_web_access' => ['admin', 'register_admin', 'teaching_admin', 'teacher', 'lunch_admin'],
        'admin_shell_access' => ['super_admin', 'admin', 'register_admin', 'teaching_admin', 'materials_admin', 'materials_moderator', 'teacher', 'lunch_admin', 'aba_teacher', 'studentstimetables_admin', 'studentstimetables_moderator'],
    ];
