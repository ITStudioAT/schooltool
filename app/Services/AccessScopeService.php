...
class AccessScopeService
{
    ...
    private const SCOPES = [
        ...
        'admin_user_profile_access' => ['user', 'super_admin', 'admin', 'register_admin', 'tutoring_admin', 'teaching_admin', 'materials_admin', 'teacher', 'studentstimetables_admin', 'studentstimetables_moderator'],
        ...
        'admin_shell_access' => ['super_admin', 'admin', 'register_admin', 'tutoring_admin', 'teaching_admin', 'materials_admin', 'materials_moderator', 'teacher', 'lunch_admin', 'aba_teacher', 'studentstimetables_admin', 'studentstimetables_moderator'],
    ];
