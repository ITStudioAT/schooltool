...
class LicenceSaveModelRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'licence_model.school_included_storage_gb' => ['nullable', 'string', 'max:255', 'regex:/^[1-9][0-9]*$/'],
            'licence_model.school_extra_storage_step_gb' => ['nullable', 'string', 'max:255', 'regex:/^[1-9][0-9]*$/'],
            'licence_model.school_extra_storage_step_price' => ['nullable', 'string', 'max:255', 'regex:/^[1-9][0-9]*$/'],
            ...
            'licence_model.admin_included_storage_gb' => ['nullable', 'string', 'max:255', 'regex:/^[1-9][0-9]*$/'],
            'licence_model.admin_extra_storage_step_gb' => ['nullable', 'string', 'max:255', 'regex:/^[1-9][0-9]*$/'],
            'licence_model.admin_extra_storage_step_price' => ['nullable', 'string', 'max:255', 'regex:/^[1-9][0-9]*$/'],
            ...
            'licence_model.user_included_storage_gb' => ['nullable', 'string', 'max:255', 'regex:/^[1-9][0-9]*$/'],
            'licence_model.user_extra_storage_step_gb' => ['nullable', 'string', 'max:255', 'regex:/^[1-9][0-9]*$/'],
            'licence_model.user_extra_storage_step_price' => ['nullable', 'string', 'max:255', 'regex:/^[1-9][0-9]*$/'],
