...
class StoreRestaurantEatingTimeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'eating_time' => [
                ...
                'string',
                'regex:/^\d{2}:\d{2}$/',
                Rule::unique('restaurant_eating_times', 'eating_time')->where(fn ($query) => $query->where('school_id', $schoolId)),
            ],
        ];
    }
