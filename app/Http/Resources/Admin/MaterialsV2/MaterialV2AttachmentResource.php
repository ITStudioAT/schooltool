...
class MaterialV2AttachmentResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'keyword_extraction_status' => $this->keyword_extraction_status,
            'keyword_extraction_error' => $this->keyword_extraction_error,
            'keywords_extracted_at' => $this->keywords_extracted_at?->toIso8601String(),
