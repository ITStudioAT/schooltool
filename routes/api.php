...
use App\Http\Controllers\Admin\Teaching\CurriculumUnitFileController;
...
Route::middleware(['api', 'throttle:global', 'throttle:api'])->group(function () {
    ...
    Route::middleware(StartSession::class)->group(function () {
        ...
        Route::post('/homepage/students-timetables/login_step_email', [StudentsTimetablesStudentController::class, 'loginStepEmail'])->middleware(['tool-licensed:StudentsTimetables,auto,studentstimetables_user', 'throttle:authentication']);
        Route::post('/homepage/students-timetables/login_step_code', [StudentsTimetablesStudentController::class, 'loginStepCode'])->middleware(['tool-licensed:StudentsTimetables,auto,studentstimetables_user', 'throttle:authentication']);
        Route::post('/homepage/students-timetables/login_step_password', [StudentsTimetablesStudentController::class, 'loginStepPassword'])->middleware(['tool-licensed:StudentsTimetables,auto,studentstimetables_user', 'throttle:authentication']);
        Route::get('/homepage/students-timetables/user', [StudentsTimetablesStudentController::class, 'user'])->middleware('tool-licensed:StudentsTimetables,auto,studentstimetables_user');
        Route::get('/homepage/students-timetables/overview', [StudentsTimetablesStudentController::class, 'overview'])->middleware(['auth:sanctum', 'tool-licensed:StudentsTimetables,auto,studentstimetables_user']);
        Route::put('/homepage/students-timetables/profile-selection', [StudentsTimetablesStudentController::class, 'updateProfileSelection'])->middleware(['auth:sanctum', 'tool-licensed:StudentsTimetables,auto,studentstimetables_user']);
        Route::delete('/homepage/students-timetables/profile-selection', [StudentsTimetablesStudentController::class, 'restoreProfileSelection'])->middleware(['auth:sanctum', 'tool-licensed:StudentsTimetables,auto,studentstimetables_user']);
        Route::post('/homepage/students-timetables/my-timetable', [StudentsTimetablesStudentController::class, 'adoptPublishedTimetable'])->middleware(['auth:sanctum', 'tool-licensed:StudentsTimetables,auto,studentstimetables_user']);
        Route::delete('/homepage/students-timetables/my-timetable', [StudentsTimetablesStudentController::class, 'deletePersonalTimetable'])->middleware(['auth:sanctum', 'tool-licensed:StudentsTimetables,auto,studentstimetables_user']);
        Route::post('/homepage/students-timetables/overview/pdf', [StudentsTimetablesStudentController::class, 'overviewPdf'])->middleware(['auth:sanctum', 'tool-licensed:StudentsTimetables,auto,studentstimetables_user']);
        Route::get('/homepage/students-timetables/evaluation-settings', [StudentsTimetablesStudentController::class, 'evaluationSettings'])->middleware(['auth:sanctum', 'tool-licensed:StudentsTimetables,auto,studentstimetables_user']);
        Route::put('/homepage/students-timetables/evaluation-settings', [StudentsTimetablesStudentController::class, 'updateEvaluationSettings'])->middleware(['auth:sanctum', 'tool-licensed:StudentsTimetables,auto,studentstimetables_user']);
        Route::post('/homepage/students-timetables/automatic-timetable', [StudentsTimetablesStudentController::class, 'automaticTimetable'])->middleware(['auth:sanctum', 'tool-licensed:StudentsTimetables,auto,studentstimetables_user']);
        Route::post('/homepage/students-timetables/automatic-timetable-availability', [StudentsTimetablesStudentController::class, 'automaticTimetableAvailability'])->middleware(['auth:sanctum', 'tool-licensed:StudentsTimetables,auto,studentstimetables_user']);
        Route::get('/homepage/students-timetables/timetable-v3/state', [HomepageStudentTimetableV3StateController::class, 'show'])->middleware(['auth:sanctum', 'tool-licensed:StudentsTimetables,auto,studentstimetables_user']);
        Route::put('/homepage/students-timetables/timetable-v3/state', [HomepageStudentTimetableV3StateController::class, 'update'])
            ->middleware(['auth:sanctum', 'tool-licensed:StudentsTimetables,auto,studentstimetables_user', 'throttle:60,1']);
        Route::get('/homepage/students-timetables/timetable-v3/timetable', [HomepageStudentTimetableV3TimetableController::class, 'show'])->middleware(['auth:sanctum', 'tool-licensed:StudentsTimetables,auto,studentstimetables_user']);
        Route::put('/homepage/students-timetables/timetable-v3/timetable', [HomepageStudentTimetableV3TimetableController::class, 'update'])
            ->middleware(['auth:sanctum', 'tool-licensed:StudentsTimetables,auto,studentstimetables_user', 'throttle:10,1']);
        Route::post('/homepage/students-timetables/change_password', [StudentsTimetablesStudentController::class, 'changePassword'])->middleware(['auth:sanctum', 'tool-licensed:StudentsTimetables,auto,studentstimetables_user']);
    });
    ...
    Route::middleware(['auth:sanctum', 'api-allowed:scope:students_timetables_access', 'tool-licensed:StudentsTimetables,auth,scope:students_timetables_access'])->group(function () {
        ...
        Route::post('/admin/students-timetables/robot/backend-timetable-availability', [StudentsTimetablesController::class, 'robotBackendTimetableAvailability']);
        ...
        Route::get('/admin/students-timetables/tt-entry-remembered-offers', [StudentsTimetablesController::class, 'ttEntryRememberedOffers']);
        Route::put('/admin/students-timetables/tt-entry-remembered-offers', [StudentsTimetablesController::class, 'updateTtEntryRememberedOffers']);
    ...
    Route::post('/admin/two-factor-challenge', TwoFactorChallengeController::class)
        ->middleware([StartSession::class, 'throttle:two-factor-challenge']);
    ...
    Route::middleware(['auth:sanctum', 'api-allowed:scope:teaching_access', 'tool-licensed:Lehrertool,auto,scope:teaching_access'])->group(function () {
        ...
        Route::get('/admin/teaching/personal-backups', [PersonalTeachingBackupController::class, 'index'])->name('admin.teaching.personalBackups.index');
        Route::post('/admin/teaching/personal-backups', [PersonalTeachingBackupController::class, 'store'])->name('admin.teaching.personalBackups.store');
        Route::post('/admin/teaching/personal-backups/import', [PersonalTeachingBackupController::class, 'import'])->name('admin.teaching.personalBackups.import');
        Route::get('/admin/teaching/personal-backups/{backup}/download', [PersonalTeachingBackupController::class, 'download'])->name('admin.teaching.personalBackups.download');
        Route::post('/admin/teaching/personal-backups/{backup}/restore', [PersonalTeachingBackupController::class, 'restore'])->name('admin.teaching.personalBackups.restore');
        Route::post('/admin/teaching/personal-backups/{backup}/request-recovery', [PersonalTeachingBackupRecoveryController::class, 'requestRecovery'])->name('admin.teaching.personalBackupRecovery.request');
        Route::get('/admin/teaching/personal-backup-recovery', [PersonalTeachingBackupRecoveryController::class, 'index'])->name('admin.teaching.personalBackupRecovery.index');
        Route::post('/admin/teaching/personal-backup-recovery/{backup}/resolve', [PersonalTeachingBackupRecoveryController::class, 'resolve'])->name('admin.teaching.personalBackupRecovery.resolve');
        ...
        Route::get('/admin/teaching/curricula/{curriculum}/topics/{topicId}/units/{unitId}/files', [CurriculumUnitFileController::class, 'index']);
        Route::post('/admin/teaching/curricula/{curriculum}/topics/{topicId}/units/{unitId}/files', [CurriculumUnitFileController::class, 'store']);
        Route::get('/admin/teaching/curricula/{curriculum}/topics/{topicId}/units/{unitId}/files/{file}/preview', [CurriculumUnitFileController::class, 'preview']);
        Route::get('/admin/teaching/curricula/{curriculum}/topics/{topicId}/units/{unitId}/files/{file}/download', [CurriculumUnitFileController::class, 'download']);
        Route::patch('/admin/teaching/curricula/{curriculum}/topics/{topicId}/units/{unitId}/files/{file}', [CurriculumUnitFileController::class, 'update']);
        Route::delete('/admin/teaching/curricula/{curriculum}/topics/{topicId}/units/{unitId}/files/{file}', [CurriculumUnitFileController::class, 'destroy']);
